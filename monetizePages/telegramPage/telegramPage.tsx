...
const TelegramPage: FC = () => {
  ...
  return (
    <PrivateLayout title='Telegram Access' className={classes.monetizeSubPage}>
        ...
        <Box className={classes.leftColumn}>
          <Box className={classes.mainContents}>
            ...
            <Box className={classes.mainContentsInner}>
              <TabHeader
                tabs={['Telegram Access', 'My Orders']}
                tabVal={currentTab}
