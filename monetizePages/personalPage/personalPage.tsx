...
import { PersonalCard, MainTabCard } from 'components/monetize/card'
...
import shoutoutIcon from 'assets/img/monetize/shoutout-sent.svg';
      ...
      <Box display='flex' flexWrap='wrap' justifyContent='space-between'>
                    ...
                    <Grid container columnSpacing={3} rowSpacing={{ xs: '17px', md: 3 }}>
                      {
                        [...Array(4)].map((el, index) => (
                          <Grid item xs={12} sm={6} md={6} xl={6} key={index}>
                            <PersonalCard onClickRefund={() => setOpenRefundDialog(true)} />
                          </Grid>
                        ))
                      }
                    </Grid>
        ...
        <Box className={classes.rightColumn}>
          <GlobalSummary
            ...
            firstValue='3,928'
            firstLabel='Shoutout Sent'
            firstIcon={<Image src={shoutoutIcon} alt='' width={34.7} height={34.7} />}
            secondValue='$19,928'
