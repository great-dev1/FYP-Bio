...
import { layoutDesigns } from 'assets/mockdata/exploreEmbedsData';

import styles from 'assets/jss/components/exploreEmbedsStyles';
const useStyles = makeStyles(styles);

const LayoutDesign = forwardRef((props, ref: Ref<HTMLDivElement>) => {
...
LayoutDesign.displayName = 'LayoutDesign';
