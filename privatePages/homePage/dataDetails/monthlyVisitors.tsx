...
import visitors from 'assets/img/homepage/visitors.svg';

import styles from 'assets/jss/pages/homePageStyles';
const useStyles = makeStyles(styles);

const MonthlyVisitors: FC = () => {

  const classes = useStyles();

  return (
    <Box className={clsx(classes.monthlyVisitors, 'data-item')} display='flex' flexDirection='column' alignItems='center' justifyContent='center'>
      <Box display='flex' className='icon-box'>
        <CustomImage src={visitors} alt='' width={70} height={60} mdWidth={49.74} mdHeight={48.23} />
      </Box>
