...
const BgImageTemplate3Template: FC = () => {

  const classes = useStyles();

  return (
    <FypBioLayout className="bg-img-3-template" title="Back Image 3 Theme" logoColor='white'>
...
export default BgImageTemplate3Template;
