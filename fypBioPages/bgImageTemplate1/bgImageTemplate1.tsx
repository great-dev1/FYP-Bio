...
const BgImageTemplate1Template: FC = () => {

  const classes = useStyles();

  return (
    <FypBioLayout className="bg-img-1-template" title="Back Image 1 Theme" logoColor='white'>
...
export default BgImageTemplate1Template;
